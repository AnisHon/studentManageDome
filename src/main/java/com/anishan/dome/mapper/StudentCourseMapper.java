...
* @Entity com.anishan.dome.domain.entity.StudentCourse
*/
public interface StudentCourseMapper extends BaseMapper<StudentCourse> {

    void deleteBatchInSchoolYear(@Param("teachId") Long teachId, @Param("userId") Long userId, @Param("year") int year);
    ...
    Long countScores(@Param("ew") Wrapper<?> wrapper);
